    ...
    sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='flex justify-between lg:items-center max-lg:flex-col gap-10'>
            ...
            className='space-y-5 text-sm text-gray-700 dark:text-gray-400'>
                ...
                <p className='max-w-md'>From strategy to execution, we craft digiral
                    solutions that move your business forward.
                </p>

                <ul className='flex gap-8'>
                    <li><a className='hover:text-primary' href='#hero'>Home</a></li>
                    <li><a className='hover:text-primary' href='#services'>Service</a></li>
                ...
                <h3 className='font-semibold'>Subscribe to our newsletter</h3>
                    ...
                    <div>
                        ...
                        className='w-full p-3 text-sm outline-none rounded
                         ...
                         border-gray-300 dark:border-gray-500'></input>
        ...
        justufy-center sm:justify-between gap-4 flex-wrap'>
            <p>Copyright 2026 © AutoDev.AI - All Right Reserved. </p>
