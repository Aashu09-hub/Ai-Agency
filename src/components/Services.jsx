...
const Services = () => {
    ...
    const servicesData = [
        {
            title: 'Advertising',
            description:'We turn bold into powerful degital solutions that connect, engage...',
  ...
  return (
    ...
    items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
      ...
      execution, we craft digital soulution that move your business 
      forward.'/>
